...
**The code below likely needs to be rewritten to conform to new versions of `BirdNET-Analyzer`, or simply replaced by using [birdnetR](https://github.com/birdnet-team/birdnetR)**
___

**Using BirdNET-Analyzer to process audio data**

*Installation and usage, including main arguments of BirdNET-Analyzer have changed since this documentation has been created. See https://birdnet-team.github.io/BirdNET-Analyzer/usage/cli.html for details* 
